...
// Authenticate user using token based authentication
//    @PostMapping("/signin")
...
//    Authenticate user using cookie based authentication
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signupRequest){
        ...
        if(userRepository.existsByEmail(signupRequest.getEmail())){
            return new ResponseEntity<>(new MessageResponse("Error: User with this email already exists!"), HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity<?> signOutUser(){
        ...
        return ResponseEntity.ok()
                ...
                .body(new MessageResponse("You've been successfully signed out."));
